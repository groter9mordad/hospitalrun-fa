    ...
    const expectedPatientHistoryRecords = [
      {
        ...
        info: 'patient.history.events.labRequested - emergency incident',
        recordId: '123',
        id: 'requestedLab123',
      },
  ...
  it('should convert completed lab events correctly', () => {
    ...
    const expectedPatientHistoryRecords = [
      ...
      },
      {
        ...
        type: HistoryRecordType.LAB,
        info: 'patient.history.events.labCompleted - emergency incident',
        recordId: '123',
        id: 'completedLab123',
      },
    ] as PatientHistoryRecord[]
  ...
  it('should convert canceled lab events correctly', () => {
    ...
    const expectedPatientHistoryRecords = [
      ...
      },
      {
        date: new Date('02/01/2021'),
        type: HistoryRecordType.LAB,
        info: 'patient.history.events.labCanceled - emergency incident',
        recordId: '123',
        id: 'canceledLab123',
      },
    ] as PatientHistoryRecord[]
    ...
    const expectedPatientHistoryRecords = [
      {
        ...
        info: 'patient.history.events.appointmentStarted - regular checkup',
        recordId: '123',
        id: 'startedAppt123',
      },
      {
        ...
        type: HistoryRecordType.APPOINTMENT,
        info: 'patient.history.events.appointmentEnded - regular checkup',
        recordId: '123',
        id: 'endedAppt123',
      },
    ] as PatientHistoryRecord[]
